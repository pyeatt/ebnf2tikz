...
// Collect all nonterminal names referenced in an AST subtree.
...
// Replace matching nonterminal references with clones of the replacement
// body.  Returns a new node if replacement occurred, or the original node
// if unchanged.
