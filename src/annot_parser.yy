...
/**
 * @file annot_parser.yy
 * @brief Bison grammar for parsing annotation blocks.
 *
 * Parses @c \\<\\<-- ... --\\>\\> annotation blocks that appear before
 * production definitions.  Recognized annotations:
 ...
 * main parser.  The scanAnnot() function provides the entry point,
 * creating a temporary parser to process an annotation string.
 *
 * @see annot_lexer.ll for the corresponding Flex tokenizer
 * @see parser.yy for the main EBNF parser
 */
